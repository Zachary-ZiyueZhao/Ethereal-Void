...
public class ModFluidTypes {
    ...
    public static final ResourceLocation MT_STILL_RL = ResourceLocation.parse("ethereal_void:block/molten_materials/molten_materials_still");
    public static final ResourceLocation WATER_FLOWING_RL = ResourceLocation.parse("block/water_flow");
    public static final ResourceLocation MT_FLOWING_RL = ResourceLocation.parse("ethereal_void:block/molten_materials/molten_materials_flow");
